const all_plants = [
    ...
    { name: 'ZZ Plant',
        number: 3,
        img: 'deploy-assets/zz-plant.webp',
        description: 
    ...
    { name: 'Rubber Plant',
        number: 6,
        img: 'deploy-assets/rubber-plant.webp',
    ...
    { name: 'Fiddle Leaf Fig',
        number: 5,
        img: 'deploy-assets/fiddle-leaf.jpg',
        description: 
    ...
    { name: 'Monstera Deliciosa',
        number: 8,
        img: 'deploy-assets/monstera.webp', 
        description: 
    ...
    { name: 'Succulents',
        number: 9,
        img: 'deploy-assets/succulents.webp',
        description:
    ...
    { name: 'Philodendron',
        number: 10,
        img: 'deploy-assets/Philodendron.jpg',
        description: 
    ...
    { name: 'Chinese Money Plant',
        number: 11,
        img: 'deploy-assets/chinese-money.webp', 
        description: 
...
function build_HTML() {
    ...
    /* Combining HTML elements */ 
        ...
        new_section.appendChild(new_h1); // add headings
        ...
        info_div.appendChild(plant_img);
        info_div.appendChild(body_copy_div);

        body_copy_div.appendChild(body_copy_p)

        body_copy_p.appendChild(plant_description);
